...
function Player(name = '') {  // passes an empty string (if no name is provided)
    ...
    this.inventory = [new Potion('health'), new Potion()]; // euqal to an array containing any object
    ...
    Player.prototype.getInventory = function() {  //method)  Using Player.prototype instead of (this)
          ...
          return false;                           // (Player.prototype) instead of (this) inorder to not make methods for every player
        };
...
///////////////////////////////////////////// PLAYER HEALTH  ////////////////////
  ...
  Player.prototype.getHealth = function() {  //method) next 2 methods to create is to check if player is alive
